module github.com/brunobmelo/consortium

go 1.18

require (
	github.com/BrunoBMelo/handlerhttp v1.0.0
...
require github.com/BrunoBMelo/appconfig v0.0.0-20220412113747-039fe5f6513d
